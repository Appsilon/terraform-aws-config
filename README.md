...
[![latest release](https://img.shields.io/github/v/release/appsilon/terraform-aws-config?style=flat-square)](https://github.com/appsilon/terraform-aws-config/releases/latest)
[![build status](https://img.shields.io/github/workflow/status/appsilon/terraform-aws-config/workflow?label=build&logo=github&style=flat-square)](https://github.com/appsilon/terraform-aws-config/actions?query=workflow%3Atest)
